...
@foreach($kelas as $k => $kls)
   @foreach ($kls as $item)
       ...
       <div class="row mt-1">
        <div class="col"><button class="btn btn-primary-bb btn-sm btn-kelas" value="{{$item["angkatan"]}}" data-toggle="modal" data-target="#modal-input-raport">Input Raport</button>
