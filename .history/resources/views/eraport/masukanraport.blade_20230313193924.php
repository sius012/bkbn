          ...
          <div class="col-md-4">
            <div class="card p-3">
              ...
              <div class="btn-group" role="group" aria-label="Basic example">
                <a href="{{route("raport.kelas.detail", ['jurusan'=>$item['jurusan'], 'angkatan'=>$item['angkatan']])}}"><button type="button" class="btn btn-primary-bb"><i class="fa fa-print"></i></button>
                  <button type="button" class="btn btn-secondary">Middle</button></a>
