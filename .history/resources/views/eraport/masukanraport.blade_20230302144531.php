    ...
    <div class="row">
        ...
        <div class="col-md-3 mx-2">
            <div class="card mx-1 p-3" style="width:300px">
             ...
             <button class="btn btn-primary btn-sm btn-class-cetak" data-toggle="modal" data-target="#modal-cetak-raport"><i class="fa fa-print"></i></button>
         </div>
  ...
  <div class="modal fade" tabindex="-1" role="dialog" id="modal-cetak-raport">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form action="{{route('eraport.unduh')}}" method="post" enctype="multipart/form-data">
        <div class="modal-body">
                ...
                <div class="form-group">
                  ...
                  <input type="datetime-local" datetime value="" class="form-control" name="dari" required>
              </div>
              <div class="form-group">
                <label for="">Sampai</label>
                <input type="datetime-local" datetime value="" class="form-control" name="sampai" required>
            </div>
