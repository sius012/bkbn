            ...
            <div class="card m-2" style="width:300px">
                <div class="card-body">
                    ...
                    <div class="container mt-3">
                        <button class="btn btn-primary-bb btn-sm btn-konsel " data-toggle="modal" data-target="#modal-konseling" value="">Ajukan Konseling</button>
                    </div>
                </div>
...
<script>
    $(document).ready(function(){
        $(".btn-konsel").click(function(){
            $(".konselor-select").children("option")
        });
