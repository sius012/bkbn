      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Ctnh: 1213232K4" name="nik">
            </div>
            <div class="form-group">
              <label for="exampleFormControlSelect2" name="">Email</label>
