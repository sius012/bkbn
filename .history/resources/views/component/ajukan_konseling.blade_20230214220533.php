    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="{{route("konseling.buat")}}" >
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-primary-bb">Ajukan</button>
          <button type="sum" class="btn btn-secondary" data-dismiss="modal">Close</button>
        </div>
      </div>
    </form>
    </div>
