        ...
        @foreach($pengajuanmasuk as $i => $pm)
            <tr>
                ...
                <td>
                    ...
                    <button class="btn btn-success btn-sm show-modal-catatan" data-toggle="modal" data-target="#modal-catatan-konselor"><i class="fa fa-check p-0"></i></button>
                </td>
            </tr>
        @endforeach
    </tbody>
...
<div class="modal fade" tabindex="-1" role="dialog" id="modal-catatan-konselor">
    ...
    <input type="hidden" name="" id="idtanggapan-field">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <textarea name="" class="form-control" id="" cols="20" rows="5" required></textarea>
          </div>
        </div>
        <div class="modal-footer">
          <button type="s" class="btn btn-primary">Kirim</button>
