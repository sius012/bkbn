        ...
        @foreach($pengajuanmasuk as $i => $pm)
            <tr>
                ...
                <td>
                    ...
                    <button class="btn btn-success btn-sm show-modal-catatan" data-toggle="modal" value="$pm->id_" data-target="#modal-catatan-konselor"><i class="fa fa-check p-0"></i></button>
                </td>
            </tr>
        @endforeach
    </tbody>
