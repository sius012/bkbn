                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                  ...
                  <div class="tab-content" id="myTabContent" style="overflow-y: scroll; height: 80vh">
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        ...
                        <form action="{{url('/lengkapidatasiswa/'.$siswa->)}}" method="post"></form>
                        <table class="table table-striped border">
                                @foreach($kolomdetail as $key => $kd)
                                    <tr>
                                        <th><b>{{$kd["display"]}}</b></th>
                                        <th class="input-data-field"><input @if($siswa->detail == null) name='{{$kd["real"]}}' placeholder='Belum Dilengkapi' @endif type="text" class="form-control"></th>
                                    </tr>
                                @endforeach
                        </table>
