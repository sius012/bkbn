...
<div class="container-fluid p-2">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <button type="button" class="btn btn-primary-bb mb-3" data-toggle="modal" data-target="#modal-tambah-siswa">Tambah Data Siswa</button>
               <div class="row">
                <div class="col">
                    <input type="text" class="form-control" placeholder="Masukan Nama" name>
                </div>
                <div class="col-sm">
                ...
                <div class="col">
                    ...
                    <button  class="btn btn-primary-bb"><i class="fa fa-search"></i>     Cari</button>
                </div>
                </div>
            </div>
        </form>
...
<div class="container-fluid p-3" style="overflow-x: scroll">
