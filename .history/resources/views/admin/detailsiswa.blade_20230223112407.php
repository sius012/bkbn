                        ...
                        <table class="table table-striped border">
                                @foreach($kolomdetail as $key => $kd)
                                    <tr>
                                        ...
                                        <th class="input-data-field"><input type="value="{{$kd['value']}}"  required @if($siswa->detail == null) name='{{$kd["real"]}}' placeholder='Belum Dilengkapi' @endif type="text" class="form-control"></th>
                                    </tr>
                                @endforeach
                        </table>
