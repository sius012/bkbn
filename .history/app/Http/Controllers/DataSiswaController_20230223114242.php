...
class DataSiswaController extends Controller
{
    ...
    public function lengkapidatasiswa(Request $req, $nis){
       // dd($req);
        ...
        echo str_replace([" "], "','","nis	hobi	nama_ayah	tanggal_lahir_ayah	tempat_lahir_ayah	nama_ibu	tanggal_lahir_ibu	tempat_lahir_ibu	nama_wali	tanggal_lahir_wali	tempat_lahir_wali	pekerjaan_ayah	pekerjaan_ibu	pekerjaan_wali	agama_ayah	agama_ibu	agama_wali	alamat_ayah	alamat_ibu	alamat_wali	
        ")
