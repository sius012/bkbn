...
Route::get('/pengajuanmasuk/', [\App\Http\Controllers\KonselingController::class,"pengajuanmasuk"]);
Route::post('/kirimcatatan/', [\App\Http\Controllers\KonselingController::class,"kirimcatatan"]);




Route::get('/eraport', [\App\Http\Controllers\EraportController::class, "eraport"]);
Route::get('/teruskanraport', [\App\Http\Controllers\EraportController::class, "injectraport"])->name('eraport.teruskan');
Route::get('/unduhraport', [\App\Http\Controllers\Admin\UnduhEraportController::class, "unduheraport"])->name('eraport.unduh');
Route::get('/cekraport', [App\Http\Controllers\Admin\UnduhEraportController::class,"check"]);
...
Route::post('/inject-raport', [\App\Http\Controllers\EraportController::class, "validasiraport"]);
Route::get('/masukan-raport', [\App\Http\Controllers\EraportController::class, "masukanraport"]);
Route::get('/daftar-raport-siswa/{angkatan}/{jurusan}',[\App\Http\Controllers\EraportController::class,"raportkelas"])->name("raport.kelas.detail");

Route::get('/unduhexcel/{id_pg}',[\App\Http\Controllers\EraportController::class, "unduhexcel"]);


Route::get('/raport-kelas-detail/{angkatan}/{jurusan}', [ \App\Http\Controllers\EraportController::class,"raportkelasdetail"])->name("raport.kelas.detail");

Route::get('/detailraport/{nis}/',[\App\Http\Controllers\EraportController::class,"detailraport"]);
Route::post('/lengkapidatasiswa/{nis}', [\App\Http\Controllers\DataSiswaController::class, "lengkapidatasiswa"]);